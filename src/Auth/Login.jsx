    ...
    <div className="min-h-screen flex bg-white font-sans text-left" dir="ltr">
      ...
      <div className="w-full lg:w-1/2 flex flex-col justify-center items-center p-8 md:p-16 bg-white z-10">
        <div className="w-full max-w-md mx-auto">
          ...
          {/* Welcome Text */}
          <div className="mb-10">
            <h2 className="text-4xl font-bold text-slate-950 mb-3">
              Welcome Back!
            </h2>
          ...
          <form className="space-y-6" onSubmit={handleLogin}>
            <div>
              <label className="block text-sm font-semibold text-slate-800 mb-2.5 text-left">
                Email Address
              </label>
              <input
                type="email"
            ...
            <div>
              <div className="flex justify-between items-center mb-2.5">
                ...
                <Link
                  to="/forgetpassword"
                  className="text-sm font-medium text-one hover:text-[#5a0707] transition-colors"
                >
                  Forgot password?
                </Link>
              </div>
              <div className="relative">
                ...
                <button
                  type="button"
                  className="absolute right-4 top-1/2 -translate-y-1/2 text-slate-400 hover:text-one transition-colors"
          ...
          <div className="mt-16 text-center text-sm text-slate-500">
            © {new Date().getFullYear()} MathPortal Education. All rights
            reserved.
          </div>
        </div>
      </div>
        ...
        <div className="absolute bottom-16 left-16 right-16 text-left z-20">
          <div className="bg-white/10 backdrop-blur-md p-8 rounded-3xl border border-white/20 inline-block">
            ...
            <p className="text-slate-100 text-lg max-w-md">
              Advanced tools to manage classrooms and analyze student
